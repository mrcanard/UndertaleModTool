...
if (Data.IsGameMaker2())
{
    ...
    using (StreamWriter writer = new StreamWriter(rootFolder + "projectA.yyp"))
    {
        ...
        writer.WriteLine(
            "    {\"resourceType\":\"GMFolder\",\"resourceVersion\":\"1.0\",\"name\":\"background\",\"folderPath\":\"folders/Scripts/compatibility/background.yy\",},"
        );
        writer.WriteLine(
            "    {\"resourceType\":\"GMFolder\",\"resourceVersion\":\"1.0\",\"name\":\"instance\",\"folderPath\":\"folders/Scripts/compatibility/instance.yy\",},"
        );
        writer.WriteLine(
            "    {\"resourceType\":\"GMFolder\",\"resourceVersion\":\"1.0\",\"name\":\"joystick\",\"folderPath\":\"folders/Scripts/compatibility/joystick.yy\",},"
        );
        writer.WriteLine(
            "    {\"resourceType\":\"GMFolder\",\"resourceVersion\":\"1.0\",\"name\":\"object\",\"folderPath\":\"folders/Scripts/compatibility/object.yy\",},"
        );
        writer.WriteLine(
            "    {\"resourceType\":\"GMFolder\",\"resourceVersion\":\"1.0\",\"name\":\"tile\",\"folderPath\":\"folders/Scripts/compatibility/tile.yy\",},"
        );
        writer.WriteLine(
    ...
    using (StreamWriter writer = new StreamWriter(rootFolder + "projectA.resource_order"))
    {
        ...
        writer.WriteLine(
            "    {\"name\":\"Objects\",\"order\":11,\"path\":\"folders/Objects.yy\",},"
        );
        writer.WriteLine("    {\"name\":\"Paths\",\"order\":5,\"path\":\"folders/Paths.yy\",},");
        writer.WriteLine("    {\"name\":\"Rooms\",\"order\":12,\"path\":\"folders/Rooms.yy\",},");
        writer.WriteLine(
            "    {\"name\":\"Scripts\",\"order\":6,\"path\":\"folders/Scripts.yy\",},"
        );
        writer.WriteLine(
            "    {\"name\":\"compatibility\",\"order\":173,\"path\":\"folders/Scripts/compatibility.yy\",},"
        );
        writer.WriteLine(
            "    {\"name\":\"background\",\"order\":1,\"path\":\"folders/Scripts/compatibility/background.yy\",},"
        );
        writer.WriteLine(
            "    {\"name\":\"instance\",\"order\":2,\"path\":\"folders/Scripts/compatibility/instance.yy\",},"
        );
        writer.WriteLine(
            "    {\"name\":\"joystick\",\"order\":3,\"path\":\"folders/Scripts/compatibility/joystick.yy\",},"
        );
        writer.WriteLine(
            "    {\"name\":\"object\",\"order\":4,\"path\":\"folders/Scripts/compatibility/object.yy\",},"
        );
        writer.WriteLine(
            "    {\"name\":\"tile\",\"order\":5,\"path\":\"folders/Scripts/compatibility/tile.yy\",},"
        );
        writer.WriteLine(
            "    {\"name\":\"view\",\"order\":6,\"path\":\"folders/Scripts/compatibility/view.yy\",},"
        );
        writer.WriteLine(
            "    {\"name\":\"Sequences\",\"order\":10,\"path\":\"folders/Sequences.yy\",},"
        );
        writer.WriteLine(
