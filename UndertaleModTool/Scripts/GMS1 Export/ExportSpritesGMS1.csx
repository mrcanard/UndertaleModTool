...
void DumpSprite(UndertaleSprite sprite)
{
    ...
    for (int i = 0; i < sprite.Textures.Count; i++)
    {
        ...
        {
            worker.ExportAsPNG(sprite.Textures[i].Texture, texFolder + "images" + Path.DirectorySeparatorChar + sprite.Name.Content + "_"+ i + ".png", null, padded); // Include padding to make sprites look neat!
