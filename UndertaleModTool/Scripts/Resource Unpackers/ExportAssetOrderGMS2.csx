...
using (StreamWriter writer = new StreamWriter(outputPath))
{
    ...
    writer.WriteLine("  \"resourceVersion\": \"1.6\",");
    writer.WriteLine("  \"name\": \"SampleGame\",");
    ...
    if (Data.Backgrounds.Count > 0)
    {
        ...
        foreach (var background in Data.Backgrounds)
        {
            ...
            {
                writer.WriteLine("    {\"id\":{\"name\":\""+ background.Name.Content +"\",\"path\":\"sprites/"+ background.Name.Content + "/"+ background.Name.Content + ".yy\",},\"order\":"+ i +",},");
            }
            i++;
        }
    }
    ...
    if (Data.Sprites.Count > 0)
    {
        ...
        {
            writer.WriteLine("    {\"id\":{\"name\":\""+ sprite.Name.Content +"\",\"path\":\"sprites/"+ sprite.Name.Content +"/"+ sprite.Name.Content +".yy\",},\"order\":"+ i +",},");
        }
    }
